...
import StartWork from "../../WorkHistory/presentation/components/StartWork";
import CompleteWork from "../../WorkHistory/presentation/components/CompleteWork";
import VerifyOtpModal from "../../WorkHistory/presentation/components/VerifyOtpModal";
...
useEffect(() => {
  ...
  return (
    <CommonCard title={translations?.sidebar.availableWork || "Available Work"} className="mt-6">
