      ...
      >
        ...
        {bookings.length > 0 && (
          <>
              ...
              {paginated.map((booking) => (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h3 className="font-semibold text-base">{booking.service?.name}</h3>
                    ...
                    <p className="text-sm text-gray-500">
                      ...
                      <p className="text-sm text-gray-500">
                      Service Category: {booking.service?.category ? categoryMap[booking.service.category] : "-"}
                    </p>
                  </div>
            ...
            {/* PAGINATION */}
            {totalPages > 1 && (
              <div className={`flex justify-center gap-2 pt-6 ${isRTL ? "flex-row-reverse" : ""}`}>
