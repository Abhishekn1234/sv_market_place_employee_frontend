...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Card wrapper */}
      <div className="w-full max-w-[360px] sm:max-w-sm md:max-w-md mb-6">
        <div className="rounded-2xl bg-white p-4 sm:p-6 md:p-8 shadow-lg">
          {/* Badge */}
          ...
          <div className="mb-6 text-center">
            <div className="mx-auto mb-3 flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-blue-600 text-white shadow-md">
