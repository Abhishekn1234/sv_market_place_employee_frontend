...
import { ShieldCheck, LockOpen, RefreshCw, Phone } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="px-6 py-6">
            ...
            <div className="bg-blue-50 rounded-xl h-20 flex items-center justify-center mb-5">
              <LockOpen className="h-9 w-9 text-blue-400" />
            </div>
              ...
              >
                {digits.map((digit, i) => (
                  <input
                    ...
                    className={`
                      w-11 h-13 text-center text-xl font-medium rounded-xl border transition-all
            ...
            <div className="flex items-center justify-between mt-4">
              <span className="text-xs text-slate-400">
                Expires in <span className="text-blue-600 font-medium">07:42</span>
              </span>
              <button
                type="button"
            ...
            <div className="border-t border-slate-100 mt-6 pt-4 text-center text-xs text-slate-400">
              Wrong number?{" "}
              <a href="/send-otp-mobile" className="text-blue-600 hover:underline font-medium">
                Go back
              </a>
            </div>
          </div>
