  ...
  >
    ...
    >
      <div className="min-w-0">
        <h2 className="text-lg sm:text-2xl font-bold">Assigned Works</h2>
    ...
    {/* FOOTER */}
    <CommonModal.Footer
      className={`sticky bottom-0 border-t px-4 sm:px-6 py-3 flex justify-end
      ${dark ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"}`}
    >
      <Button
        onClick={onClose}
        className="w-full sm:w-auto px-6 py-2 rounded-lg sm:rounded-xl font-medium"
      >
        Close
      </Button>
    </CommonModal.Footer>
